...
export default class CreateQuiz extends React.Component {
   ...
   constructor(props) {
       super(props);
       this.state = {
           categories: ['Problem solving','Analytical thinking','Logical reasoning','English'],
           categoryVal: 'Problem solving',
           ...
           <div className="create-quiz-wrapper">
               ...
               <div className="main">
                   ...
                   <div className="form card">
                       <input className="input" onChange={e => this.setState({name: e.target.value})} value={this.state.name} placeholder="Test Name" />
                       <br></br>
